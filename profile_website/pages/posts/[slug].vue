<template>
  <div class="min-h-screen bg-white">
    <!-- Post Hero -->
    <section v-if="post" class="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden bg-inverse/30">
    ...
    <!-- Post Body -->
    <section v-if="post" class="py-24 relative">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div class="lg:col-span-1 hidden lg:block">
            <div class="sticky top-32 flex flex-col items-center space-y-6">
              ...
              <span class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em] rotate-180 [writing-mode:vertical-lr]">Share Article</span>
              <div class="w-px h-24 bg-gradient-to-b from-transparent via-gray-200 to-transparent"></div>
            </div>
          </div>
